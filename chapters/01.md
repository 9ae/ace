...
Zaki: `sucks in a breathe` I to hear secrets. Why donw't you tell me some.
...
- [ ] Vio at the org. We see her be the only one who is Helga's friend. Make it clear the org is to expose the Order for corruption. est Vio as muscle rather than pure assassin.

```
Setup: Vio goes to the org's gym to train 
Turning point: in the locker room everyone avoids Helga
Lead: Lessa comes into the locker room to find Vio
```

`Lessa shows up to the org a little bruised up`

Helga: Oh my. Does madam know?
...
- [ ] What do we want to est about the powers at play in this chapter?

```
Maybe setting up the Algiheri's back story is too much for the pilot.
We should focus on how, why, and what are the goals of Vio and Zaki.
What do the powers they work for want?
And why do they work for those powers?
...
"There she goes with her apothocarey theory! It could just be seperate cases of poisoning. It's a common way to kill someone" - Helga

While Zaki had not been tracking Vio, she is kinda infamous. And he definetely knows of her.
```
