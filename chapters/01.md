...
Vio: I understand that. 

Zaki: Those born with evil stitched in their hearts, don't look back when they tread down the dark path.
...
Vio: `eyes go dark` No. No one is born evil. 

`thinks of Rein: be the invisible eyeball. Closes her eyes`.

`aerial view of the fight scene`
